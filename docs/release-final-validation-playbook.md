...
When the currently planned `v1.7.0` scope is frozen and automation is green, use [release-manual-checklist-v1.7.0.md](./release-manual-checklist-v1.7.0.md) for the shorter 2 to 3 hour manual sanity pass. If the next tagged release changes, copy/update that checklist first.
