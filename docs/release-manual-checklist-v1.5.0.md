# v1.5.0 Manual Release Checklist
...
- [ ] Confirm rebuilt artifacts and server version metadata report `1.5.0`.
...
- [ ] Release artifacts were rebuilt after the version bump and show `1.5.0`.
